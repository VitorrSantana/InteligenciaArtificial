...
no_objetivo    = No()
no_anterior    = No()
no_inicial     = No(1,no_pai_default,0,240)
no_final       = No(18,no_pai_default,0,0)
...
while(no_anterior.nodo==default or no_anterior.nodo!=no_final.nodo or no_anterior!=no_inicial):
    ...
    print(f'No atual : {chr(no_inicial.nodo + 64)}, Custo Atual: {no_inicial.get_peso_no()}')
    print('Nos abertos : ',end='')
    for no_aberto in nos_abertos:
        print(f'{chr(no_aberto.nodo + 64)}',end=' ')
    print('\n-------------------------------------')
